...
//        注：symbol为股票代码 如SZ000880
    ...
    public interface News {
        ...
        String stocknews = "/api/v1/statuses/symbol_timeline/?page_size=5&symbol={0}&content_type=10,20,30";
        ...
        // 游客模式的自选资讯
        String reportnewsByAnony = "/api/v1/statuses/symbol_timeline/?page_size=20&symbol={0}&content_type=10,20";
