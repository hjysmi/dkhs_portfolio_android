...
public class LoginActivity extends ModelAcitivity implements OnClickListener {
    ...
    private void setupLastUserInfo() {
        ...
        WaterMarkUtil.calWaterMarkImage(ivWaterMark, isVerified, verifiedType == UserEntity.VERIFIEDTYPE.EXPERT.getTypeid() ? WaterMarkUtil.TYPE_RED : WaterMarkUtil.TYPE_BLUE);
    }
