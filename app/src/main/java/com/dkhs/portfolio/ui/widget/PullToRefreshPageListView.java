 ...
 */
public class PullToRefreshPageListView extends ListView implements OnScrollListener {
    ...
    private boolean isLoadPageView;
...
//            mBootProgressBar.setVisibility(View.GONE);
    ...
    private TextView mBootTipsTextView;
    private TextView mBootLastUpdatedTextView;
    private ImageView mBootArrowImageView;
//    private ProgressBar mBootProgressBar;
    ...
    public PullToRefreshPageListView(Context pContext) {
        super(pContext);
        init(pContext);
    }

    public PullToRefreshPageListView(Context pContext, AttributeSet pAttrs) {
        super(pContext, pAttrs);
        init(pContext);
    }

    public PullToRefreshPageListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
    ...
    private void addFooterView() {
        mEndRootView = mInflater.inflate(R.layout.pull_to_refresh_page, null);
        mEndRootView.setVisibility(View.VISIBLE);

        mBootArrowImageView = (ImageView) mEndRootView.findViewById(R.id.boot_arrowImageView);
        mBootArrowImageView.setMinimumWidth(22);
        mBootArrowImageView.setMinimumHeight(13);
//        mBootProgressBar = (ProgressBar) mEndRootView.findViewById(R.id.boot_progressBar);
        mBootTipsTextView = (TextView) mEndRootView.findViewById(R.id.boot_tipsTextView);
        mBootLastUpdatedTextView = (TextView) mEndRootView.findViewById(R.id.boot_lastUpdatedTextView);
        setPageViewText();
        //
        // measureView(mEndRootView);
        // mHeadViewHeight = mEndRootView.getMeasuredHeight();
        // mHeadViewWidth = mEndRootView.getMeasuredWidth();
        //
        // mEndRootView.setPadding(0, -1 * mHeadViewHeight, 0, 0);
        // mEndRootView.invalidate();
...
//                    mBootProgressBar.setVisibility(View.VISIBLE);
                ...
                case ENDINT_MANUAL_LOAD_DONE:// 手动刷新完成
                    ...
                    // 点击加载
                    // mBootTipsTextView.setText(R.string.p2refresh_end_click_load_more);
                    mBootTipsTextView.setVisibility(View.VISIBLE);
//                    mBootProgressBar.setVisibility(View.GONE);
                ...
                case ENDINT_AUTO_LOAD_DONE:// 自动刷新完成
                    ...
                    // 更 多
                    mBootTipsTextView.setText(R.string.page_pull_to_next_refresh);
                    mBootTipsTextView.setVisibility(View.VISIBLE);
//                    mBootProgressBar.setVisibility(View.GONE);
                    mBootArrowImageView.setVisibility(View.VISIBLE);
                    mBootLastUpdatedTextView.setText(getResources().getString(R.string.page_refresh_doing_end_refresh,
        ...
        switch (mHeadState) {
            ...
            case PULL_TO_REFRESH:
                ...
                if (mIsBack) {
                    ...
                    // 下拉刷新
                    if (mCurrentPage > 1) {
                        mTipsTextView.setText(R.string.page_pull_to_pre_refresh);

                    } else {
                        mTipsTextView.setText(R.string.p2refresh_pull_to_refresh);
                    }
                    // mLastUpdatedTextView.setText(getResources().getString(R.string.page_refresh_doing_end_refresh,
                    // mCurrentPage - 1, mTotalPage));
                    // } else {
                    mLastUpdatedTextView.setText(getResources().getString(R.string.page_refresh_doing_end_refresh,
                            mCurrentPage, mTotalPage));
...
//            mBootProgressBar.setVisibility(View.VISIBLE);
    ...
    public boolean isLoadPageView() {
        return isLoadPageView;
    }

    public void setLoadPageView(boolean isLoadPageView) {
        this.isLoadPageView = isLoadPageView;
        // if (isLoadPageView) {
        // if (mCanLoadMore && getFooterViewsCount() != 0) {
        // removeFooterView(mEndRootView);
        // }
    ...
    // // mEndRootView = mInflater.inflate(R.layout.pull_to_refresh_head, null);
    // // mEndRootView.setVisibility(View.VISIBLE);
    // // mEndLoadProgressBar = (ProgressBar) mEndRootView.findViewById(R.id.pull_to_refresh_progress);
    // // mEndLoadTipsTextView = (TextView) mEndRootView.findViewById(R.id.load_more);
    // //
    //
    // mEndRootView = (LinearLayout) mInflater.inflate(R.layout.pull_to_refresh_head, null);
    //
    // mBootArrowImageView = (ImageView) mEndRootView.findViewById(R.id.head_arrowImageView);
    // mBootArrowImageView.setMinimumWidth(70);
    // mBootArrowImageView.setMinimumHeight(50);
    // mBootProgressBar = (ProgressBar) mEndRootView.findViewById(R.id.head_progressBar);
    // mBootTipsTextView = (TextView) mEndRootView.findViewById(R.id.head_tipsTextView);
    // // mLastUpdatedTextView = (TextView) mEndRootView.findViewById(R.id.head_lastUpdatedTextView);
    //
    // measureView(mEndRootView);
    // mHeadViewHeight = mEndRootView.getMeasuredHeight();
    // mHeadViewWidth = mEndRootView.getMeasuredWidth();
