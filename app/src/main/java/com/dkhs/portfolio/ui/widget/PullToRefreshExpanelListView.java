 ...
 * @version 1.0
 */
public class PullToRefreshExpanelListView extends ExpandableListView implements OnScrollListener {
...
//			mEndLoadTipsTextView.setText(msg);
	...
	public PullToRefreshExpanelListView(Context pContext) {
		super(pContext);
		init(pContext);
	}
	
	public PullToRefreshExpanelListView(Context pContext, AttributeSet pAttrs) {
		super(pContext, pAttrs);
		init(pContext);
	}

	public PullToRefreshExpanelListView(Context pContext, AttributeSet pAttrs, int pDefStyle) {
