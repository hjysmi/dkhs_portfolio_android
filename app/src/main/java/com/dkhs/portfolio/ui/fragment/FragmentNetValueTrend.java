...
//                    BitmapUtils bitmapUtils = new BitmapUtils(getActivity());
            ...
            WaterMarkUtil.calWaterMarkImage(ivWaterMark, user.verified, user.verified_type == UserEntity.VERIFIEDTYPE.EXPERT.getTypeid() ? WaterMarkUtil.TYPE_RED : WaterMarkUtil.TYPE_BLUE);
