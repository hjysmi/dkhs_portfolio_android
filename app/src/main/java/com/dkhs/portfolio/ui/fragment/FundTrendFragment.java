 ...
 * @date 2015-5-5 下午4:18:02
 */
public class FundTrendFragment extends BaseFragment implements OnClickListener {
...
//        netValueEngine = new NetValueEngine(mFundBean.id+"");
    ...
    private void handleExtras(Bundle extras) {
        ...
        if (extras != null) {
            mFundBean = Parcels.unwrap(extras.getParcelable(FundDetailActivity.EXTRA_FUND));
        }
