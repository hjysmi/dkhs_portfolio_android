...
//    GET /api/v1/funds/fund/fund_info/
    ...
    public void loadData() {
        ...
        new MyFundsEngineImpl().getMyFundInfo(myFund.getId(),listenr);
    ...
    private class MyFundInfoAdapter extends BaseAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(type == TYPE_HEAD){
                ...
                if(s != null){
                    holder2.tv_bank.setText(s.getBank().getName());
                ...
                if(record != null){
                    ...
                    holder4.tv_trade_time.setText(TimeUtils.getMDTimeString(record.getTime()));
