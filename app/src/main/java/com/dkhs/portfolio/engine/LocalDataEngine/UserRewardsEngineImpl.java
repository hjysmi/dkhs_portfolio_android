 ...
 * @Description
 */
public class UserRewardsEngineImpl extends LoadMoreDataEngine {
    ...
    public UserRewardsEngineImpl(ILoadDataBackListener loadListener, String userId, StatusType statusType) {
        super(loadListener);
        this.userId = userId;
...
//        params.addQueryStringParameter("username", userName );
        ...
        return DKHSClient.request(HttpRequest.HttpMethod.GET, DKHSUrl.BBS.getUserRewards, params, this);
    }
