 ...
 * @Description
 */
public class CommentMeEngineImpl extends LoadMoreDataEngine {
    ...
    public CommentMeEngineImpl(ILoadDataBackListener loadListener) {
        super(loadListener);
    }
...
//        params.addQueryStringParameter("type", type);
        ...
        return DKHSClient.request(HttpRequest.HttpMethod.GET, DKHSUrl.Status.getCommentMeList, params, this);
    }
