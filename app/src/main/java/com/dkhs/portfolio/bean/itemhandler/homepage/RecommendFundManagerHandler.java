...
public class RecommendFundManagerHandler extends SimpleItemHandler<FundManagerBean> {
    ...
    public void onBindView(ViewHolder vh,final  FundManagerBean data, int position) {
        ...
        vh.getTextView(R.id.tv_week_win_rate).setText(StringFromatUtils.getPercentSpan(String.valueOf(data.win_rate_week)));
        vh.getTextView(R.id.tv_week_profit_rate).setText(StringFromatUtils.getPercentSpan(String.valueOf(data.index_rate_week)));
