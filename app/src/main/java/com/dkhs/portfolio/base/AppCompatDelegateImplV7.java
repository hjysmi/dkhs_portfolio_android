package com.dkhs.portfolio.base;
...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase
    ...
    private void ensureSubDecor() {
        if (!mSubDecorInstalled) {
            ...
            if (!mWindowNoTitle) {
                if (mIsFloating) {
                    ...
                    mSubDecor = (ViewGroup) inflater.inflate(
                            android.support.v7.appcompat.R.layout.abc_dialog_title_material, null);
                    ...
                    mContext.getTheme().resolveAttribute(android.support.v7.appcompat.R.attr.actionBarTheme, outValue, true);
                    ...
                    mSubDecor = (ViewGroup) LayoutInflater.from(themedContext)
                            .inflate(android.support.v7.appcompat.R.layout.abc_screen_toolbar, null);

                    mDecorContentParent = (DecorContentParent) mSubDecor
                            .findViewById(android.support.v7.appcompat.R.id.decor_content_parent);
                ...
                if (mOverlayActionMode) {
                    mSubDecor = (ViewGroup) inflater.inflate(
                            android.support.v7.appcompat.R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    mSubDecor = (ViewGroup) inflater.inflate(android.support.v7.appcompat.R.layout.abc_screen_simple, null);
                }
            ...
            final ContentFrameLayout abcContent = (ContentFrameLayout) mSubDecor.findViewById(
                    android.support.v7.appcompat.R.id.action_bar_activity_content);
    ...
    private void applyFixedSizeWindow(ContentFrameLayout contentFrameLayout) {
        ...
        TypedArray a = mContext.obtainStyledAttributes(android.support.v7.appcompat.R.styleable.Theme);
        ...
        if (a.hasValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMinor)) {
            a.getValue(android.support.v7.appcompat.R.styleable.Theme_windowFixedHeightMinor,
    ...
    /**
     * From {@link LayoutInflaterFactory}
     */
    @Override
        ...
        if ((st.featureId == FEATURE_OPTIONS_PANEL || st.featureId == FEATURE_ACTION_BAR) &&
            ...
            if (outValue.resourceId != 0) {
                ...
                widgetTheme.resolveAttribute(
                        android.support.v7.appcompat.R.attr.actionBarWidgetTheme, outValue, true);
            } else {
                    ...
                    if (mlp.topMargin != newMargin) {
                        ...
                        if (mStatusGuard == null) {
                            ...
                            mStatusGuard.setBackgroundColor(mContext.getResources()
                                    .getColor(android.support.v7.appcompat.R.color.abc_input_method_navigation_guard));
    ...
    private static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            background = a.getResourceId(
                    android.support.v7.appcompat.R.styleable.Theme_panelBackground, 0);
            windowAnimations = a.getResourceId(
                    android.support.v7.appcompat.R.styleable.Theme_android_windowAnimationStyle, 0);
            a.recycle();
        }
