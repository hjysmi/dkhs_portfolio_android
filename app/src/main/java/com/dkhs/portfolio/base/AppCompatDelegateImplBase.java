...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowActionBar, false)) {
            mHasActionBar = true;
        }
        ...
        mIsFloating = a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_android_windowIsFloating, false);
        mWindowNoTitle = a.getBoolean(android.support.v7.appcompat.R.styleable.Theme_windowNoTitle, false);
        a.recycle();
    }
    ...
    private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
        ...
        public Drawable getThemeUpIndicator() {
            final TintTypedArray a = TintTypedArray.obtainStyledAttributes(
                    getActionBarThemedContext(), null, new int[]{ android.support.v7.appcompat.R.attr.homeAsUpIndicator });
