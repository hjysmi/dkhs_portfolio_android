...
public class FloatingActionView extends LinearLayout {
    ...
    // mType == TYPE_NORMAL ? R.drawable.fab_shadow : R.drawable.fab_shadow_mini);
    ...
    //
    // public void
    // attachToRecyclerView(@NonNull RecyclerView recyclerView, ScrollDirectionListener scrollDirectionListener) {
