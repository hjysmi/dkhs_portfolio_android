...
public class WXEntryActivity extends WechatHandlerActivity {
    ...
    public void onGetMessageFromWXReq(WXMediaMessage msg) {
        System.out.println("WXMediaMessage:" + msg);
     ...
     * 处理微信向第三方应用发起的消息
     * <p>
     * 此处用来接收从微信发送过来的消息，比方说本demo在wechatpage里面分享 应用时可以不分享应用文件，而分享一段应用的自定义信息。接受方的微信 客户端会通过这个方法，将这个信息发送回接收方手机上的本demo中，当作
     * 回调。
     * <p>
