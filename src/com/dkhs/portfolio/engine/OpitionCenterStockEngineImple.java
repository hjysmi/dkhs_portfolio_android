...
public class OpitionCenterStockEngineImple extends LoadSelectDataEngine{
    ...
    public void loadMore() {
        ...
        DKHSClient.requestByGet(MessageFormat.format(DKHSUrl.StockSymbol.opitionmarket + "&page=" + (getCurrentpage() + 1),
        		orderType), null, this);
    }

    @Override
    public void loadData() {
        DKHSClient.requestByGet(MessageFormat.format(DKHSUrl.StockSymbol.opitionmarket,
        		orderType), null, this);
