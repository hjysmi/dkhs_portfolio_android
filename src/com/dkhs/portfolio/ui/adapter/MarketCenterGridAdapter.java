 ...
 * @version 1.0
 */
public class MarketCenterGridAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter {
    ...
    public MarketCenterGridAdapter(Context context, List<MarketCenterGridItem> hasHeaderIdList, GridView mGridView) {
