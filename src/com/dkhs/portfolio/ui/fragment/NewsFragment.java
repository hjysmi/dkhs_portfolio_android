...
public class NewsFragment extends Fragment {
    ...
    private void intialTitles() {
        ...
        title.put(KEY_URL, DKHSUrl.BASE_URL + "/finance/company/f10/financeindex/" + mStockBean.id);
        titles.add(title);
        title = new HashMap<String, String>();
        title.put(KEY_TITLE, "操盘必读");
        title.put(KEY_URL, DKHSUrl.BASE_URL + "/finance/company/f10/headlines/" + mStockBean.id);
        titles.add(title);
        title = new HashMap<String, String>();
        title.put(KEY_TITLE, "股东情况");
        title.put(KEY_URL, DKHSUrl.BASE_URL + "/finance/company/f10/shareholders/" + mStockBean.id);
        titles.add(title);
        title = new HashMap<String, String>();
