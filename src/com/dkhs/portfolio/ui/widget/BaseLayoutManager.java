/**
 * @Title BaseLayoutManager.java
 * @Package com.baoyz.recyclerviewdemo
 * @Description TODO(用一句话描述该文件做什么)
 * @author zjz
 * @date 2015-1-16 下午3:47:43
 * @version V1.0
 */
...
public abstract class BaseLayoutManager extends RecyclerView.LayoutManager {
     ...
     * {@link #onLayoutChildren(android.support.v7.widget.RecyclerView.Recycler, android.support.v7.widget.RecyclerView.State)}
     * is run.
     */
     ...
     * RTL layout support is applied automatically. So if layout is RTL and {@link #getReverseLayout()} is {@code true},
     ...
     * {@link android.support.v7.widget.RecyclerView} is LTR, than it will render from RTL, if
     * {@link android.support.v7.widget.RecyclerView} is RTL, it will render from LTR.
     * <p/>
     * If you are looking for the exact same behavior of {@link android.widget.AbsListView#setStackFromBottom(boolean)},
     * use {@link #setStackFromEnd(boolean)}
     */
     ...
     * {@link android.support.v7.widget.LinearLayoutManager} lays out 1 extra page of items while smooth scrolling and 0
     * otherwise. You can override this method to implement your custom layout pre-cache logic.
     * </p>
     * <p>
     * Laying out invisible elements will eventually come with performance cost. On the other hand, in places like
     * smooth scrolling to an unknown location, this extra content helps LayoutManager to calculate a much smoother
     * scrolling; which improves user experience.
     * </p>
     * <p>
     ...
     * <p/>
     * <p>
     * RecyclerView will scroll the minimum amount that is necessary to make the target position visible. If you are
     * looking for a similar behavior to {@link android.widget.ListView#setSelection(int)} or
     * {@link android.widget.ListView#setSelectionFromTop(int, int)}, use {@link #scrollToPositionWithOffset(int, int)}.
     * </p>
     * <p/>
     * <p>
     ...
     * independent from the rest of the {@link android.support.v7.widget.LinearLayoutManager} and with little change,
     ...
     */
    protected abstract int fill(RecyclerView.Recycler recycler, RenderState renderState, RecyclerView.State state,
     ...
     * {@link android.view.View#FOCUS_BACKWARD}, {@link android.view.View#FOCUS_FORWARD} or 0 for not applicable
     ...
     * {@link #setReverseLayout(boolean)}). Views are sorted by their positions in the adapter, not in the layout.
     * <p/>
     * If RecyclerView has item decorators, they will be considered in calculations as well.
     * <p/>
     * LinearLayoutManager may pre-cache some views that are not necessarily visible. Those views are ignored in this
     * method.
     * 
     * @return The adapter position of the first visible item or
     * {@link android.support.v7.widget.RecyclerView#NO_POSITION} if
     ...
     * <p/>
     * Note that bounds check is only performed in the current orientation. That means, if LinearLayoutManager is
     * horizontal, it will only check the view's left and right edges.
     * 
     ...
     * <p/>
     * In default layout, child 0 should be closest to screen position 0 and last child should be closest to position
     * WIDTH or HEIGHT. In reverse layout, last child should be closes to screen position 0 and first child should be
    ...
    protected static class RenderState {
         ...
         * The difference with {@link #mAvailable} is that, when recycling, distance rendered for {@link #mExtra} is not
         * considered to avoid recycling visible children.
         */
        int mExtra = 0;
