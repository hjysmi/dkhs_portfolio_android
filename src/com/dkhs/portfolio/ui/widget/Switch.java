...
/**
 * The switch has two states similar to a checkbox or toggle button. But unlike the two, you see the other state which
 * is currently not selected. The switch flips from the left to the right side,
...
public class Switch extends CompoundButton {
     ...
     * @param defStyle
     * An attribute ID within the active theme containing a reference to the default style for this widget. e.g.
     ...
     * 
     * @return the text on the left. <code>null</code> shouldn't be possible, due to the button throwing an error if the
     * texts are <code>null</code>
     */
     ...
     * 
     * @return the text on the right. <code>null</code> shouldn't be possible, due to the button throwing an error if
     * the texts are <code>null</code>
     */
