 ...
 * 
 */
public class BaseDragListAdapter extends BaseAdapter implements OnCheckedChangeListener {
    private static final String TAG = "BaseDragListAdapter";
    ...
    public BaseDragListAdapter(Context context, List<SelectStockBean> dataList, DragListView mDragListView) {
