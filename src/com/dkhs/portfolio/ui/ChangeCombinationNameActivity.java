...
public class ChangeCombinationNameActivity extends ModelAcitivity implements
		OnClickListener {
	...
	private void handleExtras(Bundle extras) {
		mCombinationBean = (CombinationBean) extras
				.getSerializable(EXTRA_COMBINATION);
	...
	private void initView() {
		...
		combination_desc.setText(TextUtils.isEmpty(mCombinationBean
				.getDescription()) ? "" : mCombinationBean.getDescription());
	}
	...
	public void onClick(View v) {
		...
		case R.id.btn_right:
			//
			String combinationName = combination_name.getText().toString()
					.trim();
			...
			new MyCombinationEngineImpl().updateCombination(mCombinationBean.getId(), combinationName, combinationDesc, new ParseHttpListener<CombinationBean>() {
