...
public class GridPasswordView extends LinearLayout implements PasswordView {
    ...
    private static final int DEFAULT_OUTERLINECOLOR = 0xaa888888;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineWidth = (int) ta.getDimension(R.styleable.gridPasswordView_lineWidth_, Util.dp2px(getContext(), 1));
        ...
        outerLineColor = ta.getColor(R.styleable.gridPasswordView_outerLineColor, DEFAULT_OUTERLINECOLOR);
        lineDrawable = ta.getDrawable(R.styleable.gridPasswordView_lineColor);
        if (lineDrawable == null)
            lineDrawable = new ColorDrawable(lineColor);
        //------add by zcm----
        cornerRadius = ta.getDimensionPixelSize(R.styleable.gridPasswordView_cornerRadius, 0);
        //------add by zcm----
    ...
    private GradientDrawable generateBackgroundDrawable() {
        ...
        drawable.setStroke(lineWidth, outerLineColor);
